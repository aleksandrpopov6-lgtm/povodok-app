...
if (animalCount === 0) {
  sqlite.exec(`
    ...
    ('Мурка','cat','котёнок','Ласковая рыжая кошечка, привита, обработана от паразитов.','Нашла у мусорного контейнера — маленькая, грязная, напуганная. Отмыла, вылечила ушной клещ.','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?w=600','needs_help',1,0,0,1,'2026-03-15','Москва, Южное Бутово'),
    ('Барсик','cat','взрослый','Степенный серый кот, спокойный, ладит с детьми. Кастрирован.','Жил на улице несколько лет. Соседи кормили, но когда пришла зима — забрала его.','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1574144611937-0df059b5ef3e?w=600','needs_help',1,1,0,1,'2026-02-20','Москва, Чертаново'),
    ('Рыжик','dog','молодой','Энергичный пёс, любит людей. Знает «сидеть» и «дай лапу». Привит, чипирован.','Бросили прямо на трассе — бегал между машинами. Забрала почти под колёсами.','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1583337130417-3346a1be7dee?w=600','needs_help',1,1,0,1,'2026-03-01','Москва, Бирюлёво'),
    ('Снежинка','cat','молодой','Белоснежная красавица с голубыми глазами. Тихая и нежная.','Принесли в коробке — кто-то подбросил у подъезда зимой.','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1606214174585-fe31582dc6ee?w=600','needs_help',0,0,1,1,'2026-01-10','Москва, Тёплый Стан'),
    ('Шарик','dog','взрослый','Добрейшая дворняга, большой и пушистый, очень ласковый.','Три зимы жил возле рынка. Построила ему домик, теперь ищу семью.','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600','needs_help',1,0,0,1,'2025-12-05','Москва, Коломенское');
  `);
}
...
if (catcherCount === 0) {
  sqlite.exec(`
    ...
    ('Андрей Ловцов','+79161234567','$2b$12$GwosF3dOw7GiNZqP2t7A4OS82kk0JAvqxDv8hCFEutgZKYwxwEwKe','catcher','Москва',0,'2026-01-01'),
    ('Сергей Профи','+79031112233','$2b$12$GwosF3dOw7GiNZqP2t7A4OS82kk0JAvqxDv8hCFEutgZKYwxwEwKe','catcher','Москва',0,'2026-01-15'),
    ('Наталья Кошкина','+79265554433','$2b$12$GwosF3dOw7GiNZqP2t7A4OS82kk0JAvqxDv8hCFEutgZKYwxwEwKe','catcher','Москва',0,'2026-02-01');
    ...
    (1,'Андрей Ловцов','+79161234567','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1560250097-0b93528c311a?w=400','Профессиональный отлов кошек и собак. Работаю тихо, без стресса для животного. Все виды оборудования.','Выхино','Москва, Выхино',7,0,1,1,1,1,1,'7 лет',4.9,23,1,'2026-01-01'),
    (2,'Сергей Профи','+79031112233','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=400','Специализируюсь на диких/агрессивных животных. Опыт работы с ТСН и муниципалитетами.','Тушинская','Москва, Тушинская',10,0,1,1,1,1,0,'10 лет',5.0,41,1,'2026-01-15'),
    (3,'Наталья Кошкина','+79265554433','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1580489944761-15a19d654956?w=400','Отлавливаю только кошек. Мягкий метод без стресса.','Новогиреево','Москва, Новогиреево',5,0,1,0,0,0,1,'3 года',4.8,12,1,'2026-02-01');
  `);
}
...
if (boardingCount === 0) {
  sqlite.exec(`
    ...
    ('Передержка "Добрые руки"','+74951234567','ул. Профсоюзная, 120, Москва','Профсоюзная','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1548802673-380ab8ebc7b7?w=600','Уютная домашняя передержка. Животные живут в отдельных вольерах. Кормление 3 раза в день. Прогулки 2 раза в день. Ежедневные отчёты хозяевам.','boarding','https://yandex.ru/maps/?text=ул.+Профсоюзная+120+Москва','["https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1548802673-380ab8ebc7b7?w=600","https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1601758125946-6ec2ef64daf8?w=600","https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600"]','[{"name":"Передержка кошки","price":350},{"name":"Передержка собаки до 10 кг","price":450},{"name":"Передержка собаки от 10 кг","price":550},{"name":"Ветеринарный осмотр","price":500}]','["СБП","Банковская карта","Наличные"]',400,350,500,1,1,1,1,15,4,'9:00–21:00',4.8,34,1,'2026-01-10'),
    ('Стационар "Айболит"','+74959876543','Варшавское шоссе, 55, Москва','Варшавская','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600','Стационар при ветклинике. Круглосуточное наблюдение врачей. Есть бокс для инфекционных.','hospital_ward','https://yandex.ru/maps/?text=Варшавское+шоссе+55+Москва','["https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1587300003388-59208cc962cb?w=600","https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1548802673-380ab8ebc7b7?w=600"]','[{"name":"Стационар стандарт","price":800},{"name":"Стационар интенсив","price":1200},{"name":"Капельница","price":600}]','["СБП","Банковская карта"]',800,700,900,1,1,1,1,20,6,'Круглосуточно',4.9,56,1,'2026-01-05');
  `);
}
...
if (clinicCount === 0) {
  sqlite.exec(`
    ...
    ('Ветклиника "Зоовет"','+74952345678','Дмитровское шоссе, 71к1, Москва','Петровско-Разумовская','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1628009368231-7bb7cfcb0def?w=600','Работаем с дикими и уличными животными. Бесплатная первичная помощь для отловленных.','https://yandex.ru/maps/?text=Дмитровское+шоссе+71к1+Москва','["https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1628009368231-7bb7cfcb0def?w=600","https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?w=600"]','[{"name":"Первичная консультация","price":800},{"name":"Вакцинация","price":600},{"name":"УЗИ","price":1500},{"name":"Кастрация кота","price":3500},{"name":"Стерилизация кошки","price":5000}]','["СБП","Банковская карта","Наличные"]',1,1,1,1,1,800,'9:00–21:00',0,'paid',500,4.9,87,1,'2025-11-01'),
    ('СВЦ "Белый клык"','+74953456789','пр. Мира, 188, Москва','Ботанический сад','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?w=600','Круглосуточная экстренная помощь. Операционная, реанимация. С дикими работаем.','https://yandex.ru/maps/?text=пр.+Мира+188+Москва','["https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1532938911079-1b06ac7ceec7?w=600"]','[{"name":"Экстренная консультация","price":1200},{"name":"Операция","price":8000},{"name":"Реанимация (сутки)","price":3500}]','["СБП","Банковская карта"]',1,1,1,1,1,1200,'Круглосуточно',1,'paid',300,4.8,63,1,'2025-10-15'),
    ('Ветамбулатория "Лапа"','+74954567890','ул. Братиславская, 12, Москва','Братиславская','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1559190394-df5a28aab5c5?w=600','Доступные цены, работаем с бездомными по льготному тарифу.','https://yandex.ru/maps/?text=ул.+Братиславская+12+Москва','["https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1559190394-df5a28aab5c5?w=600"]','[{"name":"Консультация","price":500},{"name":"Вакцинация","price":400}]','["Наличные","СБП"]',0,0,0,1,1,500,'10:00–20:00',0,'free',null,4.7,41,1,'2025-12-01');
  `);
}
...
if (adCount === 0) {
  sqlite.exec(`
    INSERT INTO users (name,phone,password_hash,role,city,is_subscribed,created_at) VALUES
    ('Виолета','+79990001122','$2b$12$GwosF3dOw7GiNZqP2t7A4OS82kk0JAvqxDv8hCFEutgZKYwxwEwKe','volunteer','Москва',1,'2026-01-01');
    ...
    (4,'Виолета','+79990001122','Котёнок Персик ищет дом','Персик','cat','котёнок','Подобрала на улице, уже привит, здоров.','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1533738363-b7f9aef128ce?w=600','rehome',NULL,0,NULL,'+79990001122','Москва, Тёплый Стан','active','2026-03-10'),
    (4,'Виолета','+79990001122','Собираем на операцию Барону','Барон','dog','взрослый','Дворняга попал под машину. Нужна операция на лапу — 18 000₽.','https://povodok.pro/api/proxy-image?url=https://images.unsplash.com/photo-1548199973-03cce0bbc87b?w=600','treatment',18000,7400,'2200 7010 1234 5678','+79990001122','Москва, Бирюлёво','active','2026-03-20');
  `);
}
